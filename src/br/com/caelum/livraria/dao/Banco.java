...
//apenas uma instância desta classe será criada, assim não precisamos mexer no max-pool-size no standalone.xml
@Singleton 
@Startup //EagerInicialization = logo no início da aplicação
public class Banco {
	...
	void aposCriacao() {
		...
		System.out.println("*************  FOI CRIADA UMA INSTÂNCIA DO BANCO *************");
